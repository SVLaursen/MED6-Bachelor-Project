...
public class InteractableObject : OVRGrabbable
{
    ...
    {
        Debug.DrawRay(transform.position, Vector3.up * rayLength, Color.yellow); //UP
        Debug.DrawRay(transform.position, Vector3.down * rayLength, Color.yellow); //DOWN
        Debug.DrawRay(transform.position, Vector3.forward * rayLength, Color.yellow); //FORWARD
        Debug.DrawRay(transform.position, Vector3.back * rayLength, Color.yellow); //BACK
        Debug.DrawRay(transform.position, Vector3.left * rayLength, Color.yellow); // LEFT
        Debug.DrawRay(transform.position, Vector3.right * rayLength, Color.yellow); //RIGHT
        ...
        //BACK
        if (Physics.Raycast(transform.position, Vector3.back, out hit, rayLength))
        {
